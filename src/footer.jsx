...
import logo from './media/landingPage/staticLogo.svg';
...
function Footer() {
  ...
  return (
    <footer
      className="flex  flex-row justify-between bg-navy text-white font-light font-opensans"
      id="footer-container"
    >
      <div
      ...
      >
        ...
        >
          ...
          <div className="px-8">A Sandbox Project</div>
        </div>
        <div

...
export default class ModuleDropdown extends React.Component {
  ...
  render() {
    return (
      <div className="">
        <button
          onMouseOver={() => this.setState((prevState) => ({ buttonHover: true, dropdownHover: prevState.dropdownHover }))}
        ...
        <div
          className={`absolute ${!(this.state.buttonHover || this.state.dropdownHover) && 'hidden'} -mt-1 -ml-10 justify-start rounded-b divide-y divide-moduleDarkBlue bg-navbar`}

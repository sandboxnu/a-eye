...
export const SelectableAxisChart = (props: {
  columnSet: string[];
  initXIdx: number;
  initYIdx: number;
  labelColor: string;
...
{' '}
      ...
      <div className="raw-data-scatter">
        <BasicScatter
          colorMap={colorMap}
          points={points}
          xLabel={props.columnSet[xIdx]}
          yLabel={props.columnSet[yIdx]}
...
export const StaticAxisChart = (props: {
  xIdx: number;
  yIdx: number;
  columnSet: string[];
  classes: string[];
    ...
    <div className="pca pca-chart">
      <div className="raw-data-scatter">
        <BasicScatter
          colorMap={colorMap}
          points={points}
          xLabel={props.columnSet[props.xIdx]}
          yLabel={props.columnSet[props.yIdx]}
          labelColorHex={props.labelColorHex}
        />
      </div>
    </div>
...
export const AxisSelector = (props: {
  columnSet: string[];
  selected: number;
